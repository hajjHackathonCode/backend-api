package com.clanconnect.config;
...
@Configuration
@EnableMongoRepositories(basePackages = "com.clanconnect.repository")
@EnableMongoAuditing
public class MongoConfig extends AbstractMongoConfiguration
{
    ...
    {
        dbName = encryptor.decrypt(dbName);
